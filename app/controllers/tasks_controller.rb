class TasksController < ApplicationController
  ...
  def task_params
    permitted_params = params.require(:task).permit(:description, :result, :property_type, :city, :country, :direction, :meter_street, :transaction_type, :rent_duration, :district, :land_area, :bedrooms, :bathrooms, :property_price, :selected_language, :price_per_meter, :state, :target, :completed)
